...
public class ReminderManager extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        try {
            ...
            Boolean notificationsEnabled = SettingsFactory.get().getSRSNotifications();
            ...
            UncaughtExceptionLogger.backgroundLogError("Caught error in reminder service onReceive", t);
        }
    }
