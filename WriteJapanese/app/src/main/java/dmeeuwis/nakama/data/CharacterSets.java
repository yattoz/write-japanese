...
public class CharacterSets  {
	...
	public static CharacterStudySet joyouHS(LockChecker lc, Context context){ return new CharacterStudySet("Joyou Kanji HS", "Kanji HS", HS_DESCRIPTION, "jhs", CharacterStudySet.LockLevel.LOCKED, Kanji.JOUYOU_SS, "充妄企仰伐伏刑旬旨匠叫吐吉如", lc, Iid.get(context), true, context); }
